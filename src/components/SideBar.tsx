...
const SideBar:React.FC =() => {
  const {sortByCity,sortByCompanyName} = useActions();  // Redux 
  const{id} =useParams()
  ...
  return (
    <div className='sidebar__group'>
     ...
     {id?
     <div>
        <button className='sidebar__btn' disabled={true}>по городу</button>
        <button className='sidebar__btn' disabled={true}>по компании</button> 
      </div>
      :
      <div>
